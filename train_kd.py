...
parser.add_argument('--student_model', default='CPD', choices=CPD.models, help='chose model, default = CPD')
parser.add_argument('--teacher_model', default='CPD_darknet19_A_minimal', choices=CPD.models, help='chose model, default = CPD_darknet19_A_minimal')
...
teacher = CPD.load_model(args.student_model).to(device)
