...
class B2_VGG(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv4_1.add_module('pool3_1', nn.AvgPool2d(2, stride=2))
        self.conv4_1.add_module('conv4_1_1', nn.Conv2d(256, 512, 3, 1, 1))
        self.conv4_1.add_module('relu4_1_1', nn.ReLU())
        self.conv4_1.add_module('conv4_2_1', nn.Conv2d(512, 512, 3, 1, 1))
        self.conv4_1.add_module('relu4_2_1', nn.ReLU())
        self.conv4_1.add_module('conv4_3_1', nn.Conv2d(512, 512, 3, 1, 1))
        self.conv4_1.add_module('relu4_3_1', nn.ReLU())

        self.conv5_1 = nn.Sequential()
        self.conv5_1.add_module('pool4_1', nn.AvgPool2d(2, stride=2))
        self.conv5_1.add_module('conv5_1_1', nn.Conv2d(512, 512, 3, 1, 1))
        self.conv5_1.add_module('relu5_1_1', nn.ReLU())
        self.conv5_1.add_module('conv5_2_1', nn.Conv2d(512, 512, 3, 1, 1))
        self.conv5_1.add_module('relu5_2_1', nn.ReLU())
        self.conv5_1.add_module('conv5_3_1', nn.Conv2d(512, 512, 3, 1, 1))
        self.conv5_1.add_module('relu5_3_1', nn.ReLU())

        self.conv4_2 = nn.Sequential()
        self.conv4_2.add_module('pool3_2', nn.AvgPool2d(2, stride=2))
        self.conv4_2.add_module('conv4_1_2', nn.Conv2d(256, 512, 3, 1, 1))
        self.conv4_2.add_module('relu4_1_2', nn.ReLU())
        self.conv4_2.add_module('conv4_2_2', nn.Conv2d(512, 512, 3, 1, 1))
        self.conv4_2.add_module('relu4_2_2', nn.ReLU())
        self.conv4_2.add_module('conv4_3_2', nn.Conv2d(512, 512, 3, 1, 1))
        self.conv4_2.add_module('relu4_3_2', nn.ReLU())

        self.conv5_2 = nn.Sequential()
        self.conv5_2.add_module('pool4_2', nn.AvgPool2d(2, stride=2))
        self.conv5_2.add_module('conv5_1_2', nn.Conv2d(512, 512, 3, 1, 1))
        self.conv5_2.add_module('relu5_1_2', nn.ReLU())
        self.conv5_2.add_module('conv5_2_2', nn.Conv2d(512, 512, 3, 1, 1))
        self.conv5_2.add_module('relu5_2_2', nn.ReLU())
        self.conv5_2.add_module('conv5_3_2', nn.Conv2d(512, 512, 3, 1, 1))
        self.conv5_2.add_module('relu5_3_2', nn.ReLU())
