...
class Darknet19_A_pruned(nn.Module):
    # VGG16 with two branches
    # pooling layer at the front of block
    def __init__(self):
...
class Darknet19_A_pruned_extra(nn.Module):
    # VGG16 with two branches
    # pooling layer at the front of block
    def __init__(self):
        super(Darknet19_A_pruned_extra, self).__init__()
        self.conv1 = nn.Sequential()
        self.conv1.add_module('conv1_1', nn.Conv2d(3, 10, 3, 1, 1, bias=False))
        self.conv1.add_module('bn1_1', nn.BatchNorm2d(10))
        self.conv1.add_module('relu1_1', nn.LeakyReLU(0.1, inplace=True))
        ...
        self.conv6.add_module('Avgpool6_1', nn.AvgPool2d(2, stride=2))
        self.conv6.add_module('bn6_1', nn.BatchNorm2d(512))
        self.conv6.add_module('relu6_1', nn.LeakyReLU(0.1, inplace=True))
        self.conv6.add_module('conv6_2', nn.Conv2d(512, 256, 1, 1, 0, bias=False))
        self.conv6.add_module('bn6_2', nn.BatchNorm2d(256))
        self.conv6.add_module('relu6_2', nn.LeakyReLU(0.1, inplace=True))
        self.conv6.add_module('conv6_3', nn.Conv2d(256, 512, 3, 1, 1, bias=False))
        self.conv6.add_module('bn6_3', nn.BatchNorm2d(512))
        self.conv6.add_module('relu6_3', nn.LeakyReLU(0.1, inplace=True))
